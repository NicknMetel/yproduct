sap.ui.define([
    ...
    function (Controller, MessagePopover, MessageItem, MessageToast, Element, JSONModel,MessageBox) {
        ...
        return Controller.extend("yproduct.controller.Detail", {
            onInit: function () {
				...
				function (RTE, library) {
					...
					that.oRichTextEditor = new RTE("myRTED", {
					...
					that.getView().byId("idEditorContainerD").addItem(that.oRichTextEditor);
				});
